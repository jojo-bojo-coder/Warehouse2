...
urlpatterns = [
    ...
    path('services/<int:service_id>/packages/', views.view_service_packages, name='view_service_packages'),
    path('services/<int:service_id>/packages/add/', views.add_service_package, name='add_service_package'),
    path('packages/<int:package_id>/edit/', views.edit_service_package, name='edit_service_package'),
    path('packages/<int:package_id>/delete/', views.delete_service_package, name='delete_service_package'),
    path('packages/<int:package_id>/toggle-status/', views.toggle_package_status, name='toggle_package_status'),
