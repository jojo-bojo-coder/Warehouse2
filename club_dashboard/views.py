...
def viewReceptionists(request):
    ...
    receptionist_userprofile = UserProfile.objects.filter(
        account_type='5',
        receptionist_profile__club=getattr(user.userprofile.director_profile, 'club', None) or getattr(user.userprofile.administrator_profile, 'club', None) or getattr(user.userprofile.vendor_manager_profile,'club', None)
