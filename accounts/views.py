...
def signin(request):
    ...
    if request.method == 'POST':
        ...
        if user_profile and user_profile.account_type == '1':
            otp_required = False
        elif user_profile and user_profile.account_type == '2':
            otp_required = False
        elif user_profile and user_profile.account_type == '3':
            otp_required = False
        elif user_profile and user_profile.account_type == '4':
            otp_required = False
        elif user_profile and user_profile.account_type == '5':
            otp_required = False
        elif user_profile and user_profile.account_type == '6':
            otp_required = False
        elif user_profile and user_profile.account_type == '7':
            otp_required = False
        elif user_profile and user_profile.account_type == '8':
            otp_required = False
        elif user_profile and user_profile.account_type == '9':
            otp_required = False
